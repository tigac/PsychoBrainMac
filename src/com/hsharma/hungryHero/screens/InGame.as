...
package com.hsharma.hungryHero.screens
{
	...
	public class InGame extends Sprite
	{
		...
		private function drawGame():void
		{
			...
			button1.x = GameConstants.ITEM1_X;
			button1.y = GameConstants.ITEM1_Y;
			...
			button2.x = GameConstants.ITEM2_X;
			button2.y = GameConstants.ITEM2_Y;
...
//								hero.y -= (hero.y - (gameArea.top + gameArea.height)/2) * 0.1;
								...
								if (hero.y > stage.stageHeight * 0.5) 
									hero.rotation -= deg2rad(hitObstacle * 2);
								else 
									hero.rotation += deg2rad(hitObstacle * 2);
							}
